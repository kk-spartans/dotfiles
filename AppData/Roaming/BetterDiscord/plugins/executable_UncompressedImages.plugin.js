    ...
    (function () {
      ...
      function setAttributeWrapper(name, value) {
        try {
          ...
          if (lower === "src" && this instanceof HTMLImageElement) {
            ...
            if (transformed !== s) return origSetAttribute.call(this, "src", transformed);
          }
          ...
          if (lower === "srcset" && this instanceof HTMLImageElement) {
            ...
            if (transformed !== s) return origSetAttribute.call(this, "srcset", transformed);
          }
        } catch (_) {}
        ...
        Object.defineProperty(imgProto, "src", {
          ...
          set: function (val) {
            try {
              ...
              if (this.dataset) this.dataset.knewestUncompressedImagesCdn = transformed;
        ...
        Object.defineProperty(imgProto, "srcset", {
          ...
          set: function (val) {
            try {
              ...
              const transformed = transformSrcset(s);
              if (transformed !== s) return origSrcsetDesc.set.call(this, transformed);
            } catch (_) {}
      ...
      function processImg(img) {
        try {
          ...
          // Video filter.
          if (isVideoExtension(img.src) || urlCache.get(img.src) === "__VIDEO__") return;
          ...
          if (attrSrcset) {
            ...
            if (t !== attrSrcset) origSetAttribute.call(img, "srcset", t);
          }
        } catch (_) {}
      }
