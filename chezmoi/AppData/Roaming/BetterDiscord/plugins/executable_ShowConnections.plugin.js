    ...
    : (([Plugin, BDFDB]) => {
        ...
        const UserConnectionsComponents = class UserConnections extends BdApi.React.Component {
          render() {
            if (!loadedUsers[this.props.user.id] && !requestedUsers[this.props.user.id]) {
              ...
              queuedInstances[this.props.user.id] = []
                .concat(queuedInstances[this.props.user.id])
                .filter((n) => n);
              BDFDB.LibraryModules.UserProfileUtils.fetchProfile(this.props.user.id);
            }
            if (!loadedUsers[this.props.user.id]) {
              if (queuedInstances[this.props.user.id].indexOf(this) == -1)
                queuedInstances[this.props.user.id].push(this);
              return null;
            }
            let connections = loadedUsers[this.props.user.id].filter(
              (c) => _this.settings.connections[c.type],
            );
            ...
            return BDFDB.ReactUtils.createElement("section", {
              className: BDFDB.DOMUtils.formatClassName(
                ...
                BDFDB.disCN._showconnectionsconnectionswrapper,
              ),
              children: BDFDB.ReactUtils.createElement("div", {
                ...
                children: connections.map((c) => {
                  ...
                  let url =
                    _this.settings.general.openWebpage &&
                    provider.getPlatformUserUrl &&
                    provider.getPlatformUserUrl(c);
                  let metadata = [];
                  if (_this.settings.general.showDetails && provider.hasMetadata && c.metadata) {
                    if (c.metadata.created_at)
                      metadata.push(
                        BDFDB.ReactUtils.createElement("span", {
                          children: BDFDB.LanguageUtils.LanguageStringsFormat(
                            "MEMBER_SINCE_PLACEHOLDER",
                            new Date(c.metadata.created_at).toLocaleDateString("default", {
                              year: "numeric",
                              month: "long",
                              day: "numeric",
                            }),
                  ...
                  return BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.TooltipContainer, {
                    ...
                    tooltipConfig: {
                      backgroundColor:
                        _this.settings.general.useColoredTooltips &&
                        BDFDB.ColorUtils.change(provider.color, -0.3),
                      color:
                        !_this.settings.general.useColoredTooltips || !provider.color
                          ? "primary"
                          : null,
                    },
                    children: BDFDB.ReactUtils.createElement(
                      !url ? "div" : BDFDB.LibraryComponents.Anchor,
                      Object.assign(!url ? {} : { href: url }, {
                        className: BDFDB.DOMUtils.formatClassName(
                          BDFDB.disCN._showconnectionsconnection,
                          url && BDFDB.disCN.cursorpointer,
                        ),
                        onContextMenu: (event) => {
                          BDFDB.ContextMenuUtils.open(
                            _this,
                            event,
                              ...
                              BDFDB.LibraryComponents.MenuItems.MenuGroup,
                              {
                                children: [
                                  BDFDB.ContextMenuUtils.createItem(
                                    ...
                                    {
                                      label: BDFDB.LanguageUtils.LibraryStringsFormat(
                                        "copy",
                                        BDFDB.LanguageUtils.LanguageStrings.USERNAME,
                                      ),
                                  ...
                                  url &&
                                    BDFDB.ContextMenuUtils.createItem(
                                      BDFDB.LibraryComponents.MenuItems.MenuItem,
                                      {
                                        label: BDFDB.LanguageUtils.LibraryStringsFormat(
                                          "copy",
                                          BDFDB.LanguageUtils.LanguageStrings.COPY_LINK,
                                        ),
                                        id: BDFDB.ContextMenuUtils.createItemId(
                                          _this.name,
                                          "copy-url",
                        ...
                        children: [
                          BDFDB.ReactUtils.createElement("img", {
                            ...
                            alt: BDFDB.LanguageUtils.LanguageStringsFormat(
                              "PLACEHOLDER_LOGO",
                              provider.name,
                            ),
                            src: provider.icon[
                              this.props.popoutColor
                                ? BDFDB.ColorUtils.isBright(this.props.popoutColor)
                                  ? "lightSVG"
                                  : "darkSVG"
                                : _this.settings.general.useColoredIcons
                                  ? isLightTheme
                                    ? "lightSVG"
                                    : "darkSVG"
                                  : "whiteSVG"
                          ...
                          _this.settings.general.showVerifiedBadge &&
                            c.verified &&
                            BDFDB.ReactUtils.createElement(
                              BDFDB.LibraryComponents.TooltipContainer,
                              {
                                ...
                                children: BDFDB.ReactUtils.createElement(
                                  BDFDB.LibraryComponents.FlowerStar,
                                  {
                                    className: BDFDB.disCN._showconnectionsverifiedbadge,
                                    size: "50%",
                                    color: isLightTheme
                                      ? BDFDB.DiscordConstants.Colors.PRIMARY_200
                                      : BDFDB.DiscordConstants.Colors.PRIMARY,
                                    children: BDFDB.ReactUtils.createElement(
                                      BDFDB.LibraryComponents.SvgIcon,
                                      {
                                        ...
                                        height: "70%",
                                        color: isLightTheme
                                          ? BDFDB.DiscordConstants.Colors.PRIMARY_500
                                          : BDFDB.DiscordConstants.Colors.WHITE,
                                      },
                                    ),
                                  },
                                ),
        ...
        return class ShowConnections extends Plugin {
          onLoad() {
            ...
            this.modulePatches = { after: ["UserHeaderUsername"] };
            ...
            this.defaults = {
              general: {
                ...
                useColoredTooltips: {
                  value: true,
                  description: "Uses colored Version of the Tooltips",
                },
                showDetails: { value: true, description: "Shows Details of Connection on hover" },
                showVerifiedBadge: {
                  value: true,
                  description: "Shows the Badge for verified Connections",
                },
                openWebpage: {
                  value: true,
                  description: "Opens the Connection Page when clicking the Icon",
                },
              },
              connections: {},
            };

            for (let connection of BDFDB.LibraryModules.ConnectionProviderUtils.filter((n) => n))
              this.defaults.connections[connection.type] = Object.assign({}, connection, {
                value: true,
              });
          ...
          onStart() {
            BDFDB.PatchUtils.patch(this, BDFDB.LibraryModules.DispatchApiUtils, "dispatch", {
              after: (e) => {
                if (
                  BDFDB.ObjectUtils.is(e.methodArguments[0]) &&
                  e.methodArguments[0].type == "USER_PROFILE_FETCH_SUCCESS"
                ) {
              ...
              children: (_) => {
                ...
                settingsItems.push(
                  BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsPanelList, {
                    ...
                    children: Object.keys(this.defaults.connections).map((key) =>
                      BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsSaveItem, {
                        type: "Switch",
                        plugin: this,
                        ...
                        labelChildren: [
                          BDFDB.ReactUtils.createElement("img", {
                            ...
                            src: this.defaults.connections[key].icon.lightSVG,
                          }),
                          BDFDB.ReactUtils.createElement("img", {
                            style: { width: 28, height: 28 },
                            src: this.defaults.connections[key].icon.whiteSVG,
                          }),
                        ],
                      }),
                    ),
          ...
          processUserHeaderUsername(e) {
            ...
            if ((themeType != "SIDEBAR" && themeType != "POPOUT") || e.instance.props.className)
              return;
            let user =
              e.instance.props.user ||
              BDFDB.LibraryStores.UserStore.getUser(e.instance.props.userId);
            if (!user || user.isNonUserBot()) return;
            e.returnvalue = [e.returnvalue].flat(10);
            e.returnvalue.push(
              BDFDB.ReactUtils.createElement(
                UserConnectionsComponents,
                {
                  user: user,
                  popoutColor: BDFDB.ObjectUtils.get(
                    e.instance,
                    "props.tags.props.displayProfile.themeColors.1",
                  ),
